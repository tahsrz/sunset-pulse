...
export default async function TenantSitePage({ params, searchParams }: TenantPageProps) {
  ...
  if (path.length > 0) {
    if (path[0] === 'properties' && path[1]) {
      ...
      return (
<main data-vibe-revision-id={tenantSite.activeVibeRevisionId || undefined} className="min-h-screen bg-[#061017] text-white" style={{ fontFamily: tenantSite.fontFamily, ...tenantSite.vibeCssVars } as React.CSSProperties}>
