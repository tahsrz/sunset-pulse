...
import { ArrowRight, Crown, Gamepad2, Layers3, Spade, Waves } from 'lucide-react';
      ...
      <section className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-400">
            Small games, sharp opponents, and local-first play. Chess, Block Drop, poker, and beach volley now share the same Jamie match identity and record layer.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          ...
          <Link href="/play-jamie/poker" className="group relative overflow-hidden rounded-2xl border border-emerald-200/20 bg-gradient-to-br from-emerald-400/15 via-white/[0.04] to-amber-400/10 p-7 transition hover:-translate-y-1 hover:border-emerald-200/40">
            <div className="flex items-start justify-between gap-4">
              <span className="flex h-14 w-14 items-center justify-center rounded-xl border border-emerald-200/20 bg-emerald-200/10">
                <Spade className="h-7 w-7 text-emerald-200" />
              </span>
              <span className="rounded-full border border-emerald-200/20 bg-emerald-300/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-emerald-200">Playable</span>
            </div>
            <h2 className="mt-8 text-3xl font-black">Texas Hold&apos;em</h2>
            <p className="mt-3 max-w-md text-sm leading-6 text-slate-400">Heads-up poker with virtual chips, real hand ranking, local match records, and Jamie&apos;s table commentary.</p>
            <span className="mt-7 inline-flex items-center gap-2 text-sm font-black text-emerald-200">
              Take a seat <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" />
            </span>
          </Link>

          <Link href="/play-jamie/volley" className="group relative overflow-hidden rounded-2xl border border-amber-200/20 bg-gradient-to-br from-amber-300/15 via-white/[0.04] to-cyan-400/10 p-7 transition hover:-translate-y-1 hover:border-amber-200/40">
            <div className="flex items-start justify-between gap-4">
              <span className="flex h-14 w-14 items-center justify-center rounded-xl border border-cyan-200/20 bg-cyan-200/10">
            ...
            <h2 className="mt-8 text-3xl font-black">Sunset Volley</h2>
            <p className="mt-3 max-w-md text-sm leading-6 text-slate-400">A beach rally game with jump timing, ball physics, Jamie defense, local match records, and quick arcade rounds.</p>
            <span className="mt-7 inline-flex items-center gap-2 text-sm font-black text-amber-200">
              Hit the beach <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" />
            </span>
          </Link>
        </div>
      </section>
