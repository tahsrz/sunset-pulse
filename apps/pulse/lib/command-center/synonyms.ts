...
const DOMAIN_SYNONYMS: Record<string, string[]> = {
  ...
  velocity: ['market movement', 'absorption', 'maturation', 'trend'],
  safety: ['crime', 'incident', 'police', 'public safety', 'safe language'],
  crime: ['safety', 'incident', 'police', 'public safety'],
  incident: ['safety', 'crime', 'police report'],
  police: ['safety', 'crime', 'incident'],
  service: ['311', 'service request', 'community issue', 'city service'],
  request: ['service request', '311', 'city issue'],
  pothole: ['service request', '311', 'street issue'],
  code: ['code concern', 'service request', '311'],
  contract: ['trec', 'agreement', 'addendum', 'option fee', 'termination option'],
  trec: ['contract', 'form', 'addendum', 'option fee'],
  addendum: ['contract', 'trec', 'financing addendum'],
  option: ['option fee', 'termination option', 'option period'],
  yield: ['agricultural productivity', 'crop', 'farm', 'ranch', 'rural land'],
  agricultural: ['yield', 'crop', 'farm', 'ranch'],
  farm: ['ranch', 'rural land', 'agricultural', 'yield'],
  ranch: ['farm', 'rural land', 'agricultural', 'yield'],
  history: ['heritage', 'place history', 'town story', 'local memory'],
  heritage: ['history', 'place history', 'local story'],
  pulse: ['sunset pulse', 'command center', 'worker routing', 'tah routing'],
  command: ['route', 'routing', 'workflow', 'command center'],
  architecture: ['system design', 'component map', 'data flow', 'command flow'],
  routing: ['route', 'worker routing', 'dispatch', 'command flow'],
  security: ['threat model', 'attack surface', 'control', 'privacy risk'],
  threat: ['security', 'threat model', 'attack surface', 'risk'],
  privacy: ['security', 'data exposure', 'private context', 'control'],
  postgres: ['database', 'sql', 'query plan', 'index tuning'],
  database: ['postgres', 'sql', 'query plan', 'data model'],
  query: ['sql', 'query plan', 'database', 'retrieval'],
  index: ['index tuning', 'query plan', 'search', 'retrieval'],
  spatial: ['spatial computing', '3d', 'immersive', 'scene design'],
  immersive: ['spatial', '3d', 'scene design'],
  scene: ['spatial', '3d', 'interaction'],
...
const NORMALIZATION_ALIASES: Record<string, string[]> = {
  ...
  shops: ['shop', 'business'],
  contracts: ['contract', 'trec'],
  addenda: ['addendum'],
  incidents: ['incident'],
  requests: ['request', 'service request'],
  farms: ['farm'],
  ranches: ['ranch'],
  commands: ['command'],
