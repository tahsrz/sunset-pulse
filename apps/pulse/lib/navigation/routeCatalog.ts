...
export const appRoutes: readonly AppRoute[] = [
  ...
  ...pages('Account and business', [
    ...
    ['/sprints', 'Sprints', 'account', 'Shared owner-scoped scheduled planning workspace.'],
    ['/workspaces', 'Workspace hub', 'account', 'Select an accessible workspace or create a team workspace; creation does not invite users or enable scheduling.'],
    ['/workspace-invitations/accept', 'Accept workspace invitation', 'account', 'Email-bound one-time invitation; fragment token is not sent in the page request; requires the invited account.'],
  ...
  { path: '/admin/sprints', label: 'Sprints (legacy redirect)', group: 'Account and business', access: 'account', kind: 'redirect', href: '/sprints', note: 'Compatibility route for the shared signed-in sprint workspace.' },
