...
export function buildPropertyBacklog({ properties, existingTasks = [], occurrenceAt = new Date().toISOString() }: { properties: PropertyShortlistEntry[]; existingTasks?: ExistingPropertyTask[]; occurrenceAt?: string }) {
