...
const VibeAuditEventSchema = new mongoose.Schema({
  ...
  revisionId: { type: String }, sourceRevisionId: { type: String }, siteId: { type: String }, actorId: { type: String, required: true }, reason: { type: String, default: '' }, occurredAt: { type: Date, default: Date.now },
}, { timestamps: false });
