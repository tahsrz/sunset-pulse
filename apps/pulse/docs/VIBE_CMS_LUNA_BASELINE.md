...
Preset decision: a preset is an independent starting template. Selecting one copies safe structured theme colors, controlled taxonomy terms, and Jamie's primary voice tone into a newly created Vibe draft; it is never a live link and cannot mutate another Vibe or any site after creation.
