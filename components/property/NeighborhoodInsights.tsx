...
import { FaSchool, FaHospital, FaBus, FaInfoCircle, FaShieldAlt, FaMapMarkerAlt, FaStore } from 'react-icons/fa';
    ...
    <div className="mt-8 bg-slate-900 border border-blue-500/20 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 hover:border-blue-500/40">
      {!data && !loading && (
        <div className="p-8 text-center">
          <div className="flex justify-center mb-4">
            <FaInfoCircle size={40} className="text-blue-500" />
          </div>
          <h3 className="text-white font-black uppercase tracking-widest mb-4">Neighborhood Overview</h3>
          <p className="text-slate-400 text-sm mb-6 max-w-md mx-auto">
            Review local demographics, infrastructure, and proximity to key amenities.
          </p>
          <button 
      ...
      {loading && (
        <div className="p-12 flex flex-col items-center gap-4">
          ...
          <p className="text-[10px] font-black text-blue-400 uppercase tracking-[0.3em] animate-pulse">Retrieving market data...</p>
        </div>
      )}
        ...
        <div className="p-8 animate-in fade-in zoom-in-95 duration-500">
          <div className="flex items-center justify-between mb-8 border-b border-white/5 pb-6">
            <div>
              <h3 className="text-xl font-black text-white uppercase tracking-[0.2em] italic border-l-4 border-blue-500 pl-4 mb-1">
                Local Area Metrics <span className="text-[8px] bg-blue-500/20 text-blue-400 px-2 py-1 rounded not-italic tracking-widest ml-2">VERIFIED_DATA</span>
              </h3>
              <p className="text-[9px] text-slate-500 font-bold uppercase tracking-[0.2em] pl-5">Detailed neighborhood analysis active</p>
            </div>
            
            <div className="text-right">
              <div className="text-[8px] font-black text-blue-400 uppercase tracking-[0.3em] mb-1">Area Score</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 bg-blue-600/5 border border-blue-500/20 p-6 rounded-xl flex items-center justify-between group hover:bg-blue-600/10 transition-all">
              <div className="flex items-center gap-5">
                <div className="p-4 bg-blue-500/20 rounded-2xl text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
                  <FaStore size={24} className="group-hover:scale-110 transition-transform" />
                </div>
                <div>
                  <div className="text-blue-500 text-[8px] font-black uppercase tracking-[0.4em] mb-1">Primary Commercial Hub</div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className={`text-[10px] font-black uppercase tracking-widest ${data.neighborhood.hub.status === 'TACTICAL_ADVANTAGE' ? 'text-green-400' : 'text-blue-400'}`}>
                      {data.neighborhood.hub.status === 'TACTICAL_ADVANTAGE' ? 'High Growth Corridor' : 'Stable Submarket'}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-950/80 border border-white/5 p-5 rounded-xl flex items-start gap-4">
              ...
              <div>
                <div className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-1">Educational Facilities</div>
            ...
            <div className="bg-slate-950/80 border border-white/5 p-5 rounded-xl flex items-start gap-4">
              ...
              <div>
                <div className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-1">Infrastructure Access</div>
                <div className="text-white font-bold">{data.neighborhood.transit.nodes} Points</div>
            ...
            <div className="bg-slate-950/80 border border-white/5 p-5 rounded-xl flex items-start gap-4">
              ...
              <div>
                <div className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-1">Commercial Density</div>
                <div className="text-white font-bold">{data.neighborhood.amenities.total} Locations</div>
                <div className="text-[10px] text-yellow-400/80 font-mono mt-1">DENSITY: HIGH // REGION: STABLE</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex items-center justify-between border-t border-white/5 pt-6">
            <div className="flex items-center gap-2 text-green-400 text-[10px] font-black uppercase tracking-widest">
              <FaShieldAlt /> Data Source Verified
            </div>
            <button 
