    ...
    <div className='print-container max-w-5xl mx-auto bg-slate-900 border border-white/10 rounded-[3rem] p-12 animate-in zoom-in-95 duration-500 shadow-2xl relative'>
      ...
      <div className='no-print flex flex-col md:flex-row gap-4 mt-12'>
        {!confirmed ? (
          ...
          >
            <FaCheckCircle /> Save to Market List
          </button>
        ) : (
          <button 
            onClick={onDownload}
      ...
      <div className='mt-12 pt-8 border-t border-white/5'>
        <p className='text-[8px] font-bold text-slate-500 uppercase tracking-[0.2em] leading-loose text-center max-w-2xl mx-auto'>
          Disclaimer: This value represents an Automated Valuation Model (AVM) estimate generated by Jamie.
          It is provided for informational purposes only and does not constitute a professional appraisal, financial advice, or a guarantee of market performance. 
          All final investment decisions should be verified by a licensed appraiser or professional advisor in accordance with local regulations.
        </p>
      </div>

      {confirmed && (
        <div className='mt-8 p-6 bg-green-500/10 border border-green-500/20 rounded-3xl text-center no-print'>
          <p className='text-green-400 text-[10px] font-bold uppercase tracking-widest'>Market Analysis Saved</p>
        </div>
      )}
    </div>
  );
