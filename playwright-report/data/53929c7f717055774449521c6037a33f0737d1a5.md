...
- Name: arcade-whitebox.spec.ts >> Arcade Protocol: White-Box Analysis >> BubbleTrouble: Game Engine White-Box >> should move the player within bounds
- Location: tests\arcade-whitebox.spec.ts:45:9
...
Call log:
  - waiting for locator('.absolute.bottom-4')
