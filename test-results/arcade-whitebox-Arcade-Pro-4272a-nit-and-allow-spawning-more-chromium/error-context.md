...
- Name: arcade-whitebox.spec.ts >> Arcade Protocol: White-Box Analysis >> Insaniquarium: Biological Simulation White-Box >> should initialize with one unit and allow spawning more
- Location: tests\arcade-whitebox.spec.ts:157:9
