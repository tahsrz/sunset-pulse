...
- Name: arcade-whitebox.spec.ts >> Arcade Protocol: White-Box Analysis >> Insaniquarium: Biological Simulation White-Box >> should detect and handle system anomalies
- Location: tests\arcade-whitebox.spec.ts:196:9
