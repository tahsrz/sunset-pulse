...
- Name: arcade-whitebox.spec.ts >> Arcade Protocol: White-Box Analysis >> Insaniquarium: Biological Simulation White-Box >> should accumulate resources and allow subsystem deployment
- Location: tests\arcade-whitebox.spec.ts:166:9
...
Call log:
  - waiting for locator('button:has-text("Insaniquarium_V3")')
